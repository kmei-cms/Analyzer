...
int main()
{
	...
	//vector summarizing background histograms to include in the plot
		...
		{"T#bar{T}",        "condor/hadd_2016_MC_Samples/2016_TT.root",              "hist", kBlue - 7   },
        	{"WJetsToLNu",      "condor/hadd_2016_MC_Samples/2016_WJetsToLNu.root",      "hist", kYellow + 1 },
        	{"DYJetsToLL_M-50", "condor/hadd_2016_MC_Samples/2016_DYJetsToLL_M-50.root", "hist", kOrange + 2 },
       	 	{"QCD",             "condor/hadd_2016_MC_Samples/2016_QCD.root",             "hist", kGreen + 1  },
	        {"ST",              "condor/hadd_2016_MC_Samples/2016_ST.root",              "hist", kRed + 1    },
