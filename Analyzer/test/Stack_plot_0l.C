...
public:
    ...
    // plot FUNCTION:
    // -------------------------------   
    void plot(const std::string& histName, const std::string& xAxisLabel, const std::string& yAxisLabel = "Events", const bool isLogY = false, const std::string& cutlabel = "", const double xmin = 999.9, const double xmax = -999.9, int rebin = -1, double lumi = 35900) // lumi 2016 = 35900, lumi 2017= 41500 
    {
...
int main()
{
    ...
    histInfo data = {"Data", "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_BG_OTHER.root", "PEX0", kBlack, false};

    //vector summarizing background histograms to include in the plot
    std::vector<histInfo> bgEntries = {

        {"T#bar{T}",        "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_TT.root",              "hist", kBlue - 7   },
        {"WJetsToLNu",      "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_WJetsToLNu.root",      "hist", kYellow + 1 },
        {"DYJetsToLL_M-50", "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_DYJetsToLL_M-50.root", "hist", kOrange + 2 },
        {"QCD",             "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_QCD.root",             "hist", kGreen + 1  },
        {"ST",              "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_ST.root",              "hist", kRed + 1    },
        {"Diboson",         "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_Diboson.root",         "hist", kMagenta + 1},
        {"TTX",             "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_TTX.root",             "hist", kCyan + 1   },
        {"Triboson",        "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_Triboson.root",        "hist", kGray       },
    ...
    std::vector<histInfo> sigEntries = { 
        ...
        {"RPV m_{#tildet} = 550", "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_RPV_2t6j_mStop-550.root",        "hist", kOrange - 3}, 
        {"RPV m_{#tildet} = 350", "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_RPV_2t6j_mStop-350.root",        "hist", kGreen + 3 },
        {"SYY m_{#tildet} = 900", "condor/hadd_2016_MC_AllUpdates.04.09.2019/2016_StealthSYY_2t6j_mStop-900.root", "hist", kBlue + 1  },
    };
