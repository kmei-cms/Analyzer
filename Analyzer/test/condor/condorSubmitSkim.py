...
filestoTransfer = [environ["CMSSW_BASE"] + "/src/%s/test/MySkimAnalysis" % repo, 
...
Executable = run_SkimAnalyzer_condor.tcsh
    ...
    for s, n in sc.sampleList(ds):
        ...
        if not f == None:
            ...
            for startFileNum in xrange(0, count, nFilesPerJob):
                ...
                fileParts.append("Log = skim-log-files/MySkimAnalysis_%s_%i.log\n"%(n, startFileNum))
