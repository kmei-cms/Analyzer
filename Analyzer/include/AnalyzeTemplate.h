...
public:
    void InitHistos()
    {
        ...
        my_Histos.emplace_back(new Histo1D("h_deepESM_passBaseline1l",    200,   0.0,    1.0, "deepESM_val",                {"passBaseline1l_Good"},       weightVecAll));
        ...
        my_Histos.emplace_back(new Histo2D<int,double>("h_njets_deepESM_passBaseline1l", 20, 0.0, 20.0, "NGoodJets_pt30", 200, 0.0, 1.0, "deepESM_val", {"passBaseline1l_Good"}, weightVecAll));
        my_Histos.emplace_back(new Histo3D<int,double,int>("h_njets_deepESM_nb_passBaseline1l", 20, 0.0, 20.0, "NGoodJets_pt30", 200, 0.0, 1.0, "deepESM_val", 10, 0.0, 10.0, "NGoodBJets_pt30", {"passBaseline1l_Good"}, weightVecAll));
    }
