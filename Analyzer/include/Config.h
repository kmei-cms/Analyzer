...
private:
    void registerModules(NTupleReader& tr, const std::vector<std::string>&& modules) const
    {
        ...
        for(const auto& module : modules)
        {
            ...
            else if(module=="MakeMT2Hemispheres_0l")       tr.emplaceModule<MakeMT2Hemispheres>("GoodJets_pt45", "NGoodJets_pt45");
            else if(module=="MakeMT2Hemispheres_1l")       tr.emplaceModule<MakeMT2Hemispheres>("GoodJets_pt30", "NGoodJets_pt30");
