...
void AnalyzeBackground::Loop(NTupleReader& tr, double weight, int maxevents, std::string runtype, std::string filetag, bool isQuiet)
{
    ...
    tr.registerDerivedVar<std::string>("type",runtype);
