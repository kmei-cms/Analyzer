#define MakeTuneSystematic_cxx
#include "Analyzer/Analyzer/include/MakeTuneSystematic.h"
...
MakeTuneSystematic::MakeTuneSystematic()
{
    InitHistos();
}

//Define all your histograms here. 
void MakeTuneSystematic::InitHistos()
{
    TH1::SetDefaultSumw2();
    TH2::SetDefaultSumw2();
...
void MakeTuneSystematic::Loop(NTupleReader& tr, double weight, int maxevents, bool isQuiet)
{
...
void MakeTuneSystematic::WriteHistos(TFile* outfile)
{
    outfile->cd();
