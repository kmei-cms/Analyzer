...
void MakeNNVariables::Loop(NTupleReader& tr, double, int maxevents, bool)
{
    ...
    while( tr.getNextEvent() )
    {
        ...
        std::set<std::string> variables = {
            ...
            "lvMET_cm_phi",
            "lvMET_cm_m",
            // OldSeed  variables without ISR cheating filter
            ...
            // OldSeed vriables with ISR cheating filter
            ...
            // TopSeed variables without ISR cheating filter - Only for 0l case
            ...
            // TopSeed variables with ISR cheating filter - Only for 0l case
